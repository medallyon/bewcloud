...
export function toFileItems(
  ...
  // The Trash directory has its own dedicated nav button (FilesSidebar), so it never shows up as a regular item here.
  const directoryItems: FileItem[] = directories
